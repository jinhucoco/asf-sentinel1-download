...
def probe_sarscape():
    for p in [r'C:\Program Files\SARMAP SA\SARscape\auxiliary',
...
def main():
    ...
    print(f'[..] 探测结果: 主数据盘={disk}, ENVI={probe_envi_idl() or "未找到"}, '
    ...
    fields = [
        ...
        ('IDL_EXE', 'IDL 可执行', lambda: probe_envi_idl().replace('envi_idl.exe', 'idl.exe') if probe_envi_idl() else '', False),
