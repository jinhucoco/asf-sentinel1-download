...
def test_footprint_contains():
    ...
    big_fp = {
        "type": "Polygon",
        "coordinates": [
            [[130.0, 32.0], [132.0, 32.0], [132.0, 34.0], [130.0, 34.0], [130.0, 32.0]]
        ],
    }
    ...
    partial_fp = {
        "type": "Polygon",
        "coordinates": [
            [[130.5, 32.5], [131.5, 32.5], [131.5, 33.2], [130.5, 33.2], [130.5, 32.5]]
        ],
    }
...
def test_group_union_covers_cross_frame():
    ...
    upper = FakeGeo(
        {
            "type": "Polygon",
            "coordinates": [[[129.5, 32], [131, 32], [131, 34], [129.5, 34], [129.5, 32]]],
        }
    )
    lower = FakeGeo(
        {
            "type": "Polygon",
            "coordinates": [[[131, 32], [132, 32], [132, 34], [131, 34], [131, 32]]],
        }
    )
    # 单景都不覆盖
...
def test_check_download_url():
    ...
    for bad in (
        "http://datapool.asf.alaska.edu/xxx.zip",  # 非 HTTPS
