...
DSH 插件（2026-08-23 分仓）：已独立为 jinhucoco/insar-genie-dsh，
技能仓库不再维护 dsh/ 副本；其 assets 技能副本一致性由插件仓库的
scripts/sync_assets.py 守护（校验与技能仓库脚本 MD5 一致）。
"""
...
# DSH 插件已独立分仓（jinhucoco/insar-genie-dsh），不再维护 dsh/ 副本，DSH_PRESET 已移除
