...
#   cordis 插件 @dsh-custom/insar-genie-dsh（host 工具）：
#     以 file: 依赖方式写入 ~/.dsh/profiles/web/package.json（与 @dsh-custom/md-heading-tweak 一致），
#     随后在 web profile 目录执行 pnpm install 完成真实安装；
